...
Public Class crystal_coding
  Dim conn As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\test\Desktop\crystall\db2.accdb;Persist Security Info=False")
  Dim foryy As String
  ...
  Private Sub crystal_coding_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Dim query As String = "SELECT * FROM tb1 WHERE city='" & myform.sett() & "';"
